...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    func setupScene() {
        ...
        leftWall.eulerAngles = SCNVector3.init(0, 100.0.degreesToRadians, 0)
        ...
        leftDoorSide.position = SCNVector3.init( (-doorLength/2) + (doorLength / 2), 0, length/2)
        ...
        lightNode.position = SCNVector3.init(0, height/2 - width, 0) //or put it as 0.4
